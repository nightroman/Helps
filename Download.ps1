...
.Description
	The script downloads Helps.zip to the current location and extracts files
	to the new directory Helps. If these items exist remove them manually or
